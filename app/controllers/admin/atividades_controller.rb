class Admin::AtividadesController < AdminController
  ...
  def index
    @pessoas = Pessoa.order("nome").page(params[:page]).per(10)
  ...
  def atividade_params
    params.require(:atividade).permit(:nome, :qtd_max_alunos, :professor, :horario, :dias_semana, pessoa_ids: [], voluntario_ids: [])
  end
end
